...
| what each robustness/sensitivity diagnostic returns and permits me to infer | [Diagnostic contract reference]({{ '/assets/diagnostic-contract-reference.json' | relative_url }}) | machine-readable inputs, outputs, interpretation, non-inference, reporting, limitation, and API routes |
