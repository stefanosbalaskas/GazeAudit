"""Manual source-freeze CLI for the Korthals protocol-v2 public-data case study."""
...
from .korthals_freeze import KORTHALS_COMPANION_REPOSITORY, KORTHALS_FREEZE_WORKFLOW
from .korthals_freeze_v2 import write_korthals_source_freeze_artifacts_v2
from .korthals_v2 import KORTHALS_V2_PROTOCOL_FINGERPRINT


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="gazeaudit-korthals-source-freeze-v2",
        description=(
            "Wrap an endpoint-blind Korthals protocol-v2 source intake in an immutable "
            "execution and environment provenance envelope."
        ),
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    manifest = write_korthals_source_freeze_artifacts_v2(
        intake_dir,
