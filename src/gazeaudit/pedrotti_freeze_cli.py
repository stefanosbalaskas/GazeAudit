"""Manual source-freeze CLI for the Pedrotti/de Chambrier public-data case study."""
...
from .pedrotti_freeze import PEDROTTI_FREEZE_WORKFLOW, write_pedrotti_source_freeze_artifacts
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="gazeaudit-pedrotti-source-freeze",
        description=(
            "Wrap an endpoint-blind Pedrotti source intake in an immutable execution "
